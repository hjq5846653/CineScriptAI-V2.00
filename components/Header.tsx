        ...
        <div className="flex items-center gap-4 cursor-pointer" onClick={onReset ? onReset : undefined}>
          ...
          <div className="flex flex-col">
            <h1 className="text-xl font-bold tracking-wide text-white leading-none">
              CineScriptAI <span className="text-cinematic-accent">分镜设计</span>
            </h1>
            <span className="text-[10px] text-neutral-500 font-mono tracking-widest mt-1">AI-POWERED VISUALIZATION</span>
          </div>
        </div>
